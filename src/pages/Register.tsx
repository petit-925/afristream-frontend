...
const Register: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!alphanumericRegex.test(password)) {
      setError("Password must contain at least 6 alphanumeric characters (letters and numbers)");
      return;
    }
    ...
    <>
      ...
      <div className="min-h-screen flex flex-col md:flex-row bg-dark-900 pt-32">
        ...
        <div
          ...
          style={{ backgroundImage: 'linear-gradient(to bottom right, rgba(0,0,0,0.6), rgba(0,0,0,0.3)), url("https://images.pexels.com/photos/2660262/pexels-photo-2660262.jpeg")' }}
        >
